...
2. Real data would require Nextcloud's WebDAV API hitting `{host}/public.php/webdav/` using basic auth. Obtain the share credentials from the foundation admin out-of-band — they are intentionally NOT committed to this repository.
